...
<!-- ##{"script":"<script>const u=()=>{const t=localStorage.getItem("meek_theme");document.querySelectorAll("picture").forEach(e=>{e.querySelectorAll("source").forEach(e=>{"dark"===t?(e.media=e.media.replace("(prefers-color-scheme: dark)","all"),e.media=e.media.replace("(prefers-color-scheme: light)","not all")):"light"===t?(e.media=e.media.replace("(prefers-color-scheme: dark)","not all"),e.media=e.media.replace("(prefers-color-scheme: light)","all")):(e.media=e.media.replace("not all","(prefers-color-scheme: dark)"),e.media=e.media.replace("all","(prefers-color-scheme: dark)"))})});};u();window.addEventListener("storage",e=>{"meek_theme"===e.key&&u()});</script>"}## -->