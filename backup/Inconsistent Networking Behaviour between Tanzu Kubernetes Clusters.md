...
<p align="center">
  ...
  <picture>
    <img alt="Rule 1 illustration" src="https://github.com/user-attachments/assets/69d6ba70-d70c-4da2-aeab-dd9cd7ba504a" width="1000" style="filter: invert(1) hue-rotate(180deg);">
  </picture>
</p>
...
<!-- ##{"script":"<script>document.querySelectorAll('picture').forEach((e=>{e.querySelectorAll(`source[media*='prefers-color-scheme'],source[data-media*='prefers-color-scheme']`).forEach((e=>{e?.media.includes('prefers-color-scheme')&&(e.dataset.media=e.media);const a=localStorage.getItem('meek_theme');if('auto'===a){const a=e.getAttribute('preferred-color-scheme');e?.dataset.media.includes(a)?e.media='all':e.media='none'}else e?.dataset.media.includes(a)?e.media='all':e.media='none'}))})),document.getElementById('themeButton').addEventListener('click',(function(){document.querySelectorAll('picture').forEach((e=>{e.querySelectorAll(`source[media*='prefers-color-scheme'],source[data-media*='prefers-color-scheme']`).forEach((e=>{e?.media.includes('prefers-color-scheme')&&(e.dataset.media=e.media);const a=localStorage.getItem('meek_theme');if('auto'===a){const a=e.getAttribute('preferred-color-scheme');e?.dataset.media.includes(a)?e.media='all':e.media='none'}else e?.dataset.media.includes(a)?e.media='all':e.media='none'}))}))}));</script>"}## -->