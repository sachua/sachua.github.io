...
<p align="center">
  <picture>
    ...
    <img alt="Rule 1 illustration" src="https://github.com/user-attachments/assets/49814744-3772-4834-8e86-d5aaf90ed967" width="1000">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <img alt="Rule 2 illustration" src="https://github.com/user-attachments/assets/4ff538dd-58df-4c3d-8c0b-35cd39cee196" width="350">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <img alt="Rule 3 illustration" src="https://github.com/user-attachments/assets/6e44e829-7ad8-4607-aac6-9362d1fdafba" width="800">
  </picture>
</p>
...
<p align="center">
  <picture>
    ...
    <img alt="Rule 3 illustration" src="https://github.com/user-attachments/assets/85913e88-5781-468d-a9f5-59b9dee33100" width="700">
  </picture>
</p>
...
<!-- ##{"script":"<script>document.querySelectorAll('picture').forEach(e=>{e.querySelectorAll(`source[media*='prefers-color-scheme'],source[data-media*='prefers-color-scheme']`).forEach(e=>{e?.media.includes('prefers-color-scheme')&&(e.dataset.media=e.media);let r=localStorage.getItem('meek_theme');'auto'===r?e.media='(prefers-color-scheme: dark)':e?.dataset.media.includes(r)?e.media='all':e.media='none'})}),document.querySelector(`[title='Switch Theme']`).addEventListener('click',function(){document.querySelectorAll('picture').forEach(e=>{e.querySelectorAll(`source[media*='prefers-color-scheme'],source[data-media*='prefers-color-scheme']`).forEach(e=>{e?.media.includes('prefers-color-scheme')&&(e.dataset.media=e.media);let r=localStorage.getItem('meek_theme');'auto'===r?e.media='(prefers-color-scheme: dark)':e?.dataset.media.includes(r)?e.media='all':e.media='none'})})});</script>"}## -->