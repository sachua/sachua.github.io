Local development on Kubernetes can be a hassle since the resources required to run a Kubernetes node can be quite heavy.
...
# kube-system   rke2-ingress-nginx-controller-vvwcp                    0/1     Running     0               48s
